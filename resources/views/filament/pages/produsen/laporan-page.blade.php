{{-- Produsen Laporan Titipan Page --}}
<div>
    {{-- Header with sticky filter bar --}}
    <div class="sticky top-0 z-10 bg-white dark:bg-slate-900 border-b shadow-sm">
        <div class="px-4 py-4">
            <h1 class="fi-title text-2xl font-bold text-gray-900 dark:text-white">Laporan Titipan</h1>
    ...
    <div class="px-4 pb-6">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-slate-800">
                        <tr>
                            ...
                            @if($mode !== 'bulanan')
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell">Pedagang</th>
                            @endif
                            ...
                            <th class="px-3 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell">Retur</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($reportData as $row)
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                @if($mode !== 'bulanan')
                                    <td class="px-3 py-2 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300 hidden md:table-cell">
                                        {{ $row['pedagang_nama'] ?: '-' }}
                                    </td>
                                @endif
                                ...
                                <td class="px-3 py-2 whitespace-nowrap text-sm text-right text-rose-600 dark:text-rose-400 hidden md:table-cell">
                                    {{ $row['total_retur'] }}
                                </td>
                    ...
                    <tfoot class="bg-gray-100 dark:bg-slate-800 font-semibold">
                        <tr>
                            <td class="px-3 py-2 text-sm text-gray-700 dark:text-gray-300" colspan="{{ $mode === 'bulanan' ? 1 : 2 }}">TOTAL</td>
                            ...
                            <td class="px-3 py-2 text-sm text-right text-gray-700 dark:text-gray-300 hidden md:table-cell">{{ $totals['retur'] ?? 0 }}</td>
        ...
        @else
            <div class="text-center py-12 text-gray-500 dark:text-gray-400">
                ...
                <p class="mt-4 text-lg font-medium">Tidak ada data titipan untuk periode ini</p>
